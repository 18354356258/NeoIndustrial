...
2026 年春，在构建一套工业数字孪生平台的过程中，需要一套能同时连接 PLC、CNC、传感器、仪表等异构设备的数据采集底座。翻遍了市面上的方案：
...
不到三个月，一个人从零撸出 40 个工业协议驱动 + MQTT 双层推送 + 4 种数据库并行写入 + MCP AI 50 工具 + REST API + Dashboard。不是为了做"又一个工业软件"——是为了让数字孪生系统有一副能连接一切工业设备的神经末梢。
