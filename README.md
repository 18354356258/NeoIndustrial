...
**张成龙** — 工业自动化领域实战老兵，十余年一线摸爬滚打。

不是在实验室里写论文的那种"专家"——是真正蹲在车间地板上、趴在配电柜旁边、跟西门子和三菱和 Fanuc 死磕过的工程师。从冲压到注塑，从 CNC 到半导体，从 485 串口到 MQTT 云边协同，踩过的坑比大多数人见过的设备还多。

2016 年开始一个人写这套系统。为什么一个人干？因为市面上没有一套工具能同时搞定以下四件事：

- ❌ 国外的 Kepware / Ignition 贵得离谱，一个驱动授权够买一台机床
- ❌ 国内的组态软件太重，装个运行时就要半天，还得配一堆狗屁加密狗
- ❌ 开源方案（Node-RED / ThingsBoard）拼凑感太强，工业现场断网、重连、异常恢复一塌糊涂
- ❌ 更别提 AI 了——2024 年 AI 大爆发，工业软件还在用 90 年代的菜单和对话框
...
**IndustrialDataCollector — 一个人的工业数据操作系统**

© 2016-2026 张成龙 · 社区版 Apache 2.0 · 企业版商业许可
